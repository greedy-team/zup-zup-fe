...
export default function FindTourPledge() {
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <input
        ...
        className={`${COMMON_INPUT_CLASSNAME} mt-2 w-full border-2 border-gray-400 p-3 opacity-60 focus-visible:ring-gray-300`}
      />
    </div>
  );
}
