...
const Main = () => {
  ...
  const [isDesktopListOpen, setIsDesktopListOpen] = useState(false);
        ...
        <section className="relative flex h-full min-h-0 min-w-0 flex-col overflow-x-hidden">
          ...
          >
            ...
            {selectedMode === 'register' && (
              <div className="absolute inset-0 z-70 bg-gray-500/30" />
            )}
          </aside>

          <button
            className={`absolute top-1/2 z-50 hidden h-12 w-6 -translate-y-1/2 cursor-pointer items-center justify-center rounded-r-md bg-teal-600 text-white shadow-lg transition-all duration-300 hover:bg-teal-700 md:flex ${
