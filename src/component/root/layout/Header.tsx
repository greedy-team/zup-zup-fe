  ...
  return (
    <header className="shrink-0 border-b bg-teal-50">
      ...
      <div className="relative flex h-20 items-center sm:h-24 lg:h-28">
        ...
        */}
        <p className="absolute top-1/2 left-1/2 hidden -translate-x-1/2 -translate-y-1/2 text-center text-lg leading-tight whitespace-nowrap sm:block sm:text-xl md:text-2xl lg:text-3xl">
          {/* 첫번째 줄 검정색 폰트 */}
